...
export const heroData: Hero = {
  imageSrc: heroImage,
  name: `I'm Al Khaser Jamal Hatalan`,
  description: (
    <>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        I'm a{" "}
        <strong className="text-stone-100">Graphic/Web/Ui-Ux Designer</strong>,
  ...
  actions: [
    {
      href: "https://drive.google.com/file/d/1-ZvmpzPbSoeDJxNwLmbm9QVtq2dzNzMC/view",
      text: "Resume",
      primary: true,
...
education & will have valuable application.`,
  aboutItems: [
    ...
    {
      label: "Interests",
      text: "Designing, Basketball, Driving",
      Icon: SparklesIcon,
    },
...
export const portfolioItems: PortfolioItem[] = [
  {
    ...
    url: "https://www.pinterest.com/princeqhaz/banners/",
    image: porfolioImage1,
  },
  {
    title: "Product Design",
    description: "Illustrator & Photoshop",
    url: "https://www.pinterest.com/princeqhaz/product-design/",
    image: porfolioImage2,
  },
  {
    title: "Carton Design",
    description: "Illustrator & Photoshop",
    url: "https://www.pinterest.com/princeqhaz/carton-box-design/",
    image: porfolioImage3,
  },
  {
    title: "Social Media Post",
    description: "Illustrator & Photoshop",
    url: "https://www.pinterest.com/princeqhaz/social-media-post/",
    image: porfolioImage4,
  },
  {
    title: "Catalogue",
    description: "Illustrator, Photoshop, & Indesign",
    url: "https://www.pinterest.com/princeqhaz/catalogue/",
    image: porfolioImage5,
  },
  {
    title: "UI/UX Design",
    description: "Figma",
    url: "https://www.pinterest.com/princeqhaz/ui-designs/",
    image: porfolioImage6,
  },
  {
    title: "3D",
    description: "Photoshop & Cinema4D",
    url: "https://www.pinterest.com/princeqhaz/3d/",
...
export const experience: TimelineItem[] = [
  {
    ...
    content: (
      <p>
        As a Start-up-Company im the who is responsible for all kinds IT works
        and etc.
      </p>
    ),
  },
...
export const socialLinks: Social[] = [
  ...
  },
  {
    label: "LinkedIn",
    Icon: LinkedInIcon,
    href: "https://www.linkedin.com/in/alkhaserh/",
  },
  {
    label: "Instagram",
    Icon: InstagramIcon,
